...
author: "Muhammad Zain ul Hassan"
date: "May 14, 2020"
...
```{r }
#solution(4)
mat<-matrix(seq(2,19,2),nrow=3,ncol=3)
mat
...
```{r }
#solution(5)
id<-c(12,"hassan","zain","3th")
names(id)<-c("id","lastname","firstname","class")
id
#### End solution ####
```
...
```{r }
#solution(1)
f<-factor(c("Employed", "Self-Employed","Unemployed","Employed","Unemployed", "Self-Employed","Unemployed", "Self-Employed","Employed", "Self-Employed"),
...
```{r }
#Solution(1,2,3)
bank_customers<-data.frame(CustomerID=101:105,hasAccount=c(NA,"Yes","Yes","Yes",NA),totalBalance=c(NA,"10,000","100","2000",NA))
bank_customers
```
